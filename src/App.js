...
function App() {
  return (
    < MDBContainer fluid id="drum-machine" className=' d-flex align-items-center justify-content-center px-0 bg-secondary' style={{ height: '100vh' }} >
      <MDBContainer  className='bg-dark border-2  rounded-1 d-flex justify-content-center align-items-center p-0' style={{ maxWidth: '18rem' }}>
       
        <MDBCard shadow='0' className='p-1 bg-dark rounded-1' >
          {/* <MDBInput className='num__input '/> */}
          <MDBContainer fluid className=' bg-secondary bg-opacity-25 bg-gradient  d-flex align-items-center justify-content-end text-light rounded-1 mt-1' style={{height: '4rem', width: '97%'}}>123234</MDBContainer>
        <MDBCardBody className=' d-flex align-items-center justify-content-center pt-2 pb-1'>
          <MDBRow className='row-cols-1 row-cols-md-1 g-1'>
            <MDBCol className='d-flex  justify-content-center'>
              ...
              <MDBCol className='d-flex  justify-content-center'>
                <MDBBtn size='lg'  className='norm__button bg-info bg-opacity-50' shadow-0>4</MDBBtn>
